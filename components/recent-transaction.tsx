  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center">
        ...
        <div className="ml-auto truncate font-medium">+$1,999.00</div>
      </div>
      <div className="flex items-center">
        ...
        <div className="ml-auto truncate font-medium">+$39.00</div>
      </div>
      <div className="flex items-center">
        <Avatar className="h-9 w-9">
        ...
        <div className="ml-auto truncate font-medium">+$299.00</div>
      </div>
      <div className="flex items-center">
        <Avatar className="h-9 w-9">
        ...
        <div className="ml-auto truncate font-medium">+$99.00</div>
      </div>
      <div className="flex items-center">
        <Avatar className="h-9 w-9">
